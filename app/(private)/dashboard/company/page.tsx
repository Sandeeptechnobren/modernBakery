          ...
          config={{
            header: {
              ...
              actions: [
                ...
                <span key="mobile" className="inline sm:hidden justify-center w-12">
                  <SidebarBtn href="/dashboard/company/add" isActive leadingIcon="lucide:plus" label="" />
                </span>,
              ],
            },
